...
std::map<sf::String, sf::Color> sfe::RichText::colors = {
	...
	// custom colors
	{"magical", sf::Color(30, 250, 0, 255)},
	{"rare", sf::Color(0, 110, 220, 255)},
	{"epic", sf::Color(160, 50, 240, 255)},
	{"fixedart", sf::Color(240, 120, 0, 255)},
	{"randart", sf::Color(240, 240, 0, 255)},
	{"item", sf::Color(210, 180, 100, 255)},

	{"affix", sf::Color(50, 250, 50, 255)},

	{"skill", sf::Color(200, 150, 0, 255)},
	{"spell", sf::Color(0, 200, 200, 255)},

	{"damage", sf::Color(225, 100, 0, 255)},
	{"heal", sf::Color(0, 200, 0, 255)},

	{"player", sf::Color(100, 100, 250, 255)},
	{"monster", sf::Color(250, 100, 100, 255)},
...
namespace sfe
{
	...
	void RichText::setString(const sf::String& source) {
		...
		for (unsigned int i = 0; i < chunks.size(); ++i) {
			...
			texts.push_back(t);
			cursor += static_cast<int>(chunks[i].text.getSize());
			lastChunk = &chunks[i];
		}
	}
	...
	void RichText::addColor(const sf::String& name, unsigned int argbHex) {
	...
	*/
	...
	sf::Color RichText::getColor(const sf::String& source) const {
	...
	sf::Color RichText::getColor(unsigned int argbHex) const {
		argbHex |= 0xff000000;
